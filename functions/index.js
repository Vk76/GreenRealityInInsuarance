...
const project = 'green-reality-270507';
const region = 'us-central1';
const automl_model = 'ICN7453488169623748608';
...
exports.callCustomModel = (event,context) => {
    ...
    return file.download({destination: destination})
        ...
        .then((response) => {
			...
			db.collection('images').doc(event.name).doc('Allowed Price').set(100);
